...
```{r, fig.cap= "Fall line cities from Alabama to North Carolina [@bleakley_portage_2012]"}
knitr::include_graphics(here::here("resources", "01-intro", "images", "portage.PNG"))
```
